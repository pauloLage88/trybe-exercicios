...
const aoClicar = (evento) => {
    ...
    for (const elemento of alvo.parentElement.children) {
        if (elemento !== alvo) {
...
firstLi.addEventListener('click', aoClicar);
secondLi.addEventListener('click', aoClicar);
thirdLi.addEventListener('click', aoClicar);
...
input.addEventListener ('keyup', () => {
    ...
    document.querySelector('.tech').innerHTML = `${textoDigitado}`
});
